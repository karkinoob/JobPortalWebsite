...
<body>
    <form>
        <div class="container">
            ...
            <div class="mb-3">
                <label for="phonenumber" class="form-label"><h2>PhoneNumber</h2></label>
            ...
            <div class="mb-5">
                <label for="exampleInputPasswordAgain" class="form-label"><h2>PasswordAgain</h2></label>
                <input type="password" class="form-control" id="exampleInputPasswordAgain">
            </div>
            <button type="submit" class="btn btn-primary">Submit</button>
        </form>
        <a href="login.php.php"><h5>Login</h5></a>
    </div>
