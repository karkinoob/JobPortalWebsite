    ...
    ?>
        <div class="card mb-4 job-card">
            ...
            <p class="mb-3"><strong>Applications Received:</strong> <?php echo $total_applications; ?></p>
                ...
                <a href="admin_delete_job.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm btn-action" onclick="return confirm('Are you sure you want to delete this job?')">🗑 Delete</a> wa
            </div>
        </div>
    <?php
        }
