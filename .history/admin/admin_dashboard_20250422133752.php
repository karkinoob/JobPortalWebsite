...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="admin_view_applications.php?job_id=<?php echo $row['id']; ?>" class="btn btn-info btn-sm btn-action">📄 View Applications</a>
        ...
        ?>
                <div class="card mb-4 job-card">
                    <div class="card-body">
                        ...
                        <a href="admin_delete_job.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this job?')">🗑️ Delete</a>
                    </div>
                </div>
        <?php
            }
