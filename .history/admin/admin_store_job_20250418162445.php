...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO jobs (company_name, job_title, job_description, address, job_category, valid_till, created_at)
            VALUES ('$admin_id', '$company', '$title', '$desc', '$address', '$category', '$valid_till', NOW())";
