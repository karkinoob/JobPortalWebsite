...
<body>
    <form class="edit-job-form" action="" method="POST">
        <h2>Edit Job</h2>
        ...
        <textarea name="job_description" rows="5" required><?= $job['job_description'] ?></textarea>

        <label>Address:</label>
        <input type="text" name="address" value="<?= $job['address'] ?>" required>
        ...
        <input type="date" name="valid_till" value="<?= $job['valid_till'] ?>" required>
